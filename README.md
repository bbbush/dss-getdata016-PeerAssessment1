(course project requirements from https://class.coursera.org/getdata-016/human_grading/view/courses/973758/assessments)
...
The repository contains one R script called run_analysis.R that does the following. 
